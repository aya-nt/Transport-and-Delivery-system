...
import { Search, Package, MapPin, Calendar, User, FileText, DollarSign, Phone } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <header className="bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link href="/login" className="px-6 py-2 bg-primary text-white rounded-lg font-medium hover:bg-primary-dark transition-all">
            Staff Login
          </Link>
        </div>
      </header>
